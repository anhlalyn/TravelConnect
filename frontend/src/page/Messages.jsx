...
const Messages = () => {
  ...
  useEffect(() => {
    ...
    const handleNewMessage = (incomingMessage) => {
      if (Number(incomingMessage.id_phong) === Number(activeRoomIdRef.current)) {
  ...
  const handleToggleRecording = async () => {
    ...
    try {
      ...
      recorder.onstop = async () => {
        ...
        const audioFile = new File([audioBlob], `voice-message.${audioExtension}`, {
  ...
  const renderMessageContent = (message) => {
    ...
    return <p className="leading-relaxed whitespace-pre-wrap">{message.noi_dung}</p>
  }
            ...
            <div className="p-5 border-b border-gray-50 space-y-4">
              ...
              <div className="flex gap-3 overflow-x-auto pb-2">
                {friends.map((friend) => (
                  ...
                  >
                    <div className="w-12 h-12 bg-blue-100 rounded-2xl flex items-center justify-center text-blue-600 font-bold border-2 border-white shadow-sm group-hover:border-blue-500 transition-all uppercase">
                      {friend.ten?.charAt(0)}
                    </div>
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              {rooms.map((room) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-12 h-12 rounded-xl flex items-center justify-center font-bold shrink-0 uppercase ${
                        isActive ? 'bg-white/20' : 'bg-indigo-100 text-indigo-600'
                      }`}
                    >
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex justify-between items-center mb-0.5 gap-2">
                        <p className="font-bold text-sm truncate">{room.ten_hien_thi}</p>
                        {room.loai_phong === 'nhom' && (
              ...
              <>
                <div className="p-4 bg-white border-b border-gray-100 flex justify-between items-center gap-3">
                  <div className="flex items-center gap-3 min-w-0">
                    <div className="w-10 h-10 bg-indigo-600 rounded-xl flex items-center justify-center text-white font-bold uppercase shadow-md shrink-0">
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-4">
                  {messages.map((message) => {
                    const isMine = Number(message.id_nguoi_gui) === Number(user?.id)
                    return (
                      <div
                        key={message.id}
              ...
              <div className="max-h-72 overflow-y-auto space-y-2">
                {friends.map((friend) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3 min-w-0">
                        <div className="w-10 h-10 rounded-2xl bg-slate-100 flex items-center justify-center font-black uppercase shrink-0">
                          {friend.ten?.charAt(0)}
                        </div>
              ...
              {callType === 'video' ? (
                ...
                <div className="w-full h-full flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-white text-lg font-medium">{activeRoom?.ten_hien_thi}</p>
                  </div>
                </div>
              )}
            </div>
